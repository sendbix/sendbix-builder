...
const Tabs: React.FC<TabsProps> = props => {
  ...
  return (
    ...
    >
      <div className='sendbix-builder-tabWrapper'>
        <Stack
                ...
                return (
                  <div
                    ...
                    className={classnames(
                      'sendbix-builder-tabItem',
                      !activeTab && index === 0 && 'sendbix-builder-tabActiveItem',
                      activeTab === item.key && 'sendbix-builder-tabActiveItem',
                    )}
                  >
                    <Button noBorder>
                      <>{item.props.tab}</>
